...
2. `売上進捗`: 年度累計の売上KPI、目標/実績/予測、チーム別売上進捗、平均単価、失注・辞退理由を表示する。
...
- **売上進捗ページの追加**: `dashboardData.kpis`、`monthlyTrend`、`teamsData`、`unitPriceTrend`、`lossReasons` を使って、年度累計の売上達成状況をファネルとは別軸で確認できます。
