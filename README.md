# 💊 M3キャリア 薬剤師紹介営業ダッシュボード 仕様書 (Ver. 2.2 - 開発者向け完全版)

本ドキュメントは、**M3キャリア株式会社**における薬剤師紹介営業管理ダッシュボード（フロントエンド・モックアップ）の内部仕様、データ構造、数式モデル、およびUIコンポーネントの挙動を定義した開発者向けの完全な仕様書（Spec Sheet）です。
